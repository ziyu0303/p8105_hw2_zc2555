...
*
The precipitation_df_2018 dataset contains `r nrow(precipitation_df_2018)` rows and `r ncol(precipitation_df_2018)`. The total precipitation in 2018 is `r sum(pull(precipitation_df_2018,Total)) `
